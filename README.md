...
In academic and government institutions, "Extension" refers to community outreach, technology transfer, or public training programs. Because these projects often last for many months or even years, the administration needs a way to track their progress.

Here is exactly how this feature benefits the web app and its users:
...
**Benefit to App:** The **Quarterly Reports Dashboard** makes this incredibly easy. The Extension Director can go to the dashboard, filter by `Year: 2024`, and instantly see every single narrative report submitted by every single project in the university that year. They can easily copy this data to build their annual institutional reports.
